                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="single-country__gray-box">
                                ...
                                <?php if (get_field('age')): ?><p class="single-country__info">
                                    <span><?php echo __('Возраст:', 'interavers'); ?></span>
                                    <?php the_field('age'); ?></p><?php endif; ?>
                                <?php if (get_field('requirements')): ?><p class="single-country__info">
                                    <span><?php echo __('Требования:', 'interavers'); ?></span>
                                    <?php the_field('requirements'); ?>
                                    </p><?php endif; ?>
                                <?php if (get_field('responsibilities')): ?><p class="single-country__info">
                                    <span><?php echo __('Обязанности:', 'interavers'); ?></span>
                                    <?php the_field('responsibilities'); ?>
                                    </p><?php endif; ?>
                                <?php if (get_field('working_conditions')): ?><p class="single-country__info">
                                    <span><?php echo __('Условия работы:', 'interavers'); ?></span>
                                    <?php the_field('working_conditions'); ?>
                                    </p><?php endif; ?>
                                <?php if (get_field('work_experience')): ?><p class="single-country__info">
                                    <span><?php echo __('Опыт работы:', 'interavers'); ?></span>
                                    <?php the_field('work_experience'); ?>
                                    </p><?php endif; ?>
                                <?php if (get_field('price')): ?><p class="single-country__info">
                                    <span><?php echo __('Зарплата:', 'interavers'); ?></span>
                                    <?php the_field('price'); ?>
                                    </p><?php endif; ?>
                                <?php if (get_field('continueu')): ?><p class="single-country__info">
                                    <span><?php echo __('Минимальное кол-во часов:', 'interavers'); ?></span>
                                    <?php the_field('continueu'); ?>
                                    </p><?php endif; ?>
                                <?php if (get_field('weekend')): ?><p class="single-country__info">
                                    <span><?php echo __('Выходные:', 'interavers'); ?></span>
                                    <?php the_field('weekend'); ?>
                                    </p><?php endif; ?>
                                <?php if (get_field('place_for_live')): ?><p class="single-country__info">
                                    <span><?php echo __('Проживание:', 'interavers'); ?></span>
                                    <?php the_field('place_for_live'); ?>
                                    </p><?php endif; ?>
                                <?php if (get_field('food')): ?><p class="single-country__info">
                                    <span><?php echo __('Питание:', 'interavers'); ?></span>
                                    <?php the_field('food'); ?>
                                    </p><?php endif; ?>
                            </div>
                        </div>
